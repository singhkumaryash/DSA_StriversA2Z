...
// Problem Statement : Given the head of a linked list, determine the length of
// a loop present in the linked list. If there's no loop present, return 0.

// Input: head = [3,2,0,-4], pos = 1
// Output: loop length is 3
// Explanation: There is a cycle in the linked from index 1 to 3.
...
// Brute Force (Hashing)
int loopLengthBruteForce(ListNode *head)
{
...
int main()
{
    ...
    cout << loopLengthBruteForce(head) << endl;
